      ...
      <div className='flex gap-2 mb-3 mt-3'>
        {
          ...
          <>
            <label className='flex items-center' htmlFor="resumeUpload">
              <p className='bg-blue-100 text-blue-950 px-4 py-2 rounded-lg mr-2'>{resume ? resume.name : "Select Resume"}</p>
          ...
          : <div className='flex gap-2'>
            <a target='_blank' className='bg-blue-100 text-blue-950 px-4 py-2 rounded-lg' href={userData?.resume}>
              Resume
            </a>
